...
class UpdateUserInfoInAppSessionHandler extends Handler {
    ...
    public execute = async (event: UpdateUserInfoInAppSession): Promise<void> => {
        ...
        try {
            ...
            this.bus.publish(new FailedUpdateUserInfoInAppSession(e));
        }
    }
}

export default UpdateUserInfoInAppSessionHandler;