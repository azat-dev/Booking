 ...
 */
@JsonPropertyOrder({
  UpdateUserPhoto200ResponseDTO.JSON_PROPERTY_MESSAGE
})
...
public class UpdateUserPhoto200ResponseDTO {
  ...
  public UpdateUserPhoto200ResponseDTO() {
  }

  /**
  * Constructor with all args parameters
  */
  public UpdateUserPhoto200ResponseDTO(@JsonProperty(JSON_PROPERTY_MESSAGE) String message) {
  ...
  **/
  ...
  public static class Builder {
    ...
    private UpdateUserPhoto200ResponseDTO instance;

    public Builder() {
      this(new UpdateUserPhoto200ResponseDTO());
    }

    protected Builder(UpdateUserPhoto200ResponseDTO instance) {
      this.instance = instance;
    }

    public UpdateUserPhoto200ResponseDTO.Builder message(String message) {
    ...
    /**
    * returns a built UpdateUserPhoto200ResponseDTO instance.
    *
    * The builder is not reusable.
    */
    public UpdateUserPhoto200ResponseDTO build() {
      try {
  ...
  */
  public static UpdateUserPhoto200ResponseDTO.Builder builder() {
    return new UpdateUserPhoto200ResponseDTO.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public UpdateUserPhoto200ResponseDTO.Builder toBuilder() {
    return new UpdateUserPhoto200ResponseDTO.Builder()
      .message(getMessage());
  }
