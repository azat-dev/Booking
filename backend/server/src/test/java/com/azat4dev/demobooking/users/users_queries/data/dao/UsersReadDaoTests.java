...
class UsersReadDaoImpl implements UsersReadDao {
...
@JdbcTest
@Sql({"classpath:users/h2/schema.sql", "classpath:users/h2/data.sql"})
public class UsersReadDaoTests {

    @Autowired
    JdbcTemplate jdbcTemplate;

    SUT createSUT() {
        return new SUT(new UsersReadDaoImpl());
    }
