...
public interface CommandsModificationsApi {
    ...
    default CommandsModificationsApiDelegate getDelegate() {
        return new CommandsModificationsApiDelegate() {};
    }
    ...
    @Operation(
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "401", description = "Not valid Token", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AddListing401Response.class))
            }),
    ...
    default ResponseEntity<AddListingResponse> addListing(
        ...
        return getDelegate().addListing(addListingRequestBody);
    }
