package com.azat4dev.booking.users.commands.domain.handlers.user;
...
import com.azat4dev.booking.users.commands.domain.core.commands.GenerateUserPhotoUploadUrl;
import com.azat4dev.booking.users.commands.domain.handlers.users.photo.GenerateUrlForUploadUserPhoto;
import com.azat4dev.booking.users.commands.domain.handlers.users.photo.GenerateUrlForUploadUserPhotoImpl;
import com.azat4dev.booking.users.commands.domain.handlers.users.photo.GenerateUserPhotoObjectName;
...
public class GenerateUrlForUploadUserPhotoTests {
    ...
    SUT createSUT() {
        ...
        final var expiresIn = Duration.ofSeconds(5);
