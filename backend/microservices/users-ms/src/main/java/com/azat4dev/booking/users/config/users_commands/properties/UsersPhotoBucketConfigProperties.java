...
@Getter
@ConfigurationProperties(prefix = "app.objects-storage.bucket.users-photo")
public class UsersPhotoBucketConfigProperties {
    ...
    @ConstructorBinding
    public UsersPhotoBucketConfigProperties(
        @NotNull
        String name,
        URL endpoint,
        @NotNull
